...
module.exports = class Menu {
    static defaultReactions = { back: '◀', next: '▶' }

    constructor(opts = {}) {
        const { channel = new TextChannel, userID, pages = [], page = 0, time = 600000, reactions = Menu.defaultReactions, customCatch = console.error } = opts
